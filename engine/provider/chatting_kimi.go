...
func (c *Chatting_kimi) GetDict() Dict {
	dict := Dict{}
	dict.Name = "kimi"
	return dict
}

func (c *Chatting_kimi) Chat(params map[string]string, messages []ChatMessage, callback func(msg []ChatMessage, is_done bool) error, is_suspend func() bool) error {
	var err error
